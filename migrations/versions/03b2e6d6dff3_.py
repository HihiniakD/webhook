...
Revision ID: 03b2e6d6dff3
Revises: 87aa08753ece
Create Date: 2021-04-29 10:47:49.558078
...
revision = '03b2e6d6dff3'
down_revision = '87aa08753ece'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.PrimaryKeyConstraint('id', name='test_base_pkey')
    )
